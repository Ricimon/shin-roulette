...
all_fights = []
all_fights.extend([Fight(s, standard_composition, False, True) for s in normal_fights])
all_fights.extend([Fight(s, standard_composition, False, True) for s in extreme_fights])
all_fights.extend([Fight(s, standard_composition, False, True) for s in savage_fights])
all_fights.extend(
    [Fight(s, standard_composition, False, True) for s in ultimate_fights]
)
all_fights.extend([Fight(s, alliance_composition, True, True) for s in alliance_fights])
all_fights.extend(
